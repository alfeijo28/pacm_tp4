  ...
  //al_set_audio_stream_playing(songSugar, true);
   ...
   while(1){//loop para rodar enquanto o usuário não iniciar o jogo
        ...
        if(ev.type == ALLEGRO_EVENT_TIMER){
          ghosts_move(gposx_1, gposy_1, gposx_2, gposy_2, gposx_3, gposy_3, gposx_4, gposy_4, gmovement_1, gmovement_2, gmovement_3, gmovement_4, started, i, j, chase_1, chase_2, chase_3, chase_4);          
